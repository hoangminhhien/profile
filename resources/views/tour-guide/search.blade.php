...
@section('content')
<div class="list-hdv">
  @for ($i = 0; $i <= 5; $i++) <div class="card item-hdv">
    <div class="card-body">
      <div class="row">
        <div class="col-4">
        ...
        <div class="col-8">
          ...
          <div class="pull-right">
            <button type="button" class="btn btn-warning"
              style="background-color: orange; color: white; border-radius: 10px; font-size: 12px">Đặt lịch</button>
          </div>
          ...
          <div>
            <i class="fa fa-sitemap" aria-hidden="true"></i> Tổ chức Gala Dinner, Tổ chức team building, Kiến thức văn
            hoá
          </div>
          <div>
